...
@section('title', 'Moderate Comments - Admin')

@section('content')
<!-- Admin Comments Hero Section -->
<div class="admin-comments-hero position-relative overflow-hidden mb-4">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                ...
                <p class="text-white-50 mb-0 subtitle-hero">
                    Review and manage user comments across your platform
                </p>
            </div>
        </div>
    </div>
...
<div class="container pb-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="admin-comments-container bg-white shadow-sm rounded-4 p-4 p-md-5 mb-4">
                <!-- Admin Controls -->
                <div class="admin-controls mb-4 d-flex justify-content-between align-items-center">
                    <h2 class="section-title mb-0">All Comments</h2>
                ...
                <div class="table-responsive">
                    <table class="table table-hover comments-table">
                        ...
                        <tbody>
                            ...
                            <tr class="comment-row fade-in">
                                <td>{{ $comment->id }}</td>
                                <td>{{ $comment->story ? $comment->story->title : 'N/A' }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('admin.comments.show', $comment->id) }}" class="action-btn btn-view">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                        <form action="{{ route('admin.comments.destroy', $comment->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Are you sure you want to delete this comment?');" class="action-btn btn-delete">
                ...
                <div class="empty-state text-center py-5">
                    ...
                    <p class="text-muted">There are no comments to moderate at this time.</p>
                </div>
                @endif
            </div>
        </div>
